...
if __name__ == '__main__':
    main()
# DATA_ROOT=dataset/PatchesDataset python tools/train_poly.py configs/bpr/poly_hrnet48_256.py --gpus 1 --gpu-ids 1 --work-dir work_dirs/poly_hrnet48_256 --launcher pytorch